...
#define STRING_CONFIG_H_AUTHOR "(IACU, RobinNanoTFT35)" // Who made the changes.
...
// remember to read and set the eeprom:
// m502
// m500
...
#define TFT_MARLINUI_COLOR COLOR_GREY // main foreground color
#define TFT_MARLINBG_COLOR COLOR_BLACK  // background color
#define TFT_BTCANCEL_COLOR COLOR_RED      // cancel button
#define TFT_BTARROWS_COLOR COLOR_DARKGREY // arrows up/down
#define TFT_BTOKMENU_COLOR COLOR_DARKGREY2 // enter button
